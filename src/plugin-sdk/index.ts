...
export type { CoderClawConfig } from "../config/config.js";
/** @deprecated Use CoderClawConfig instead */
export type { CoderClawConfig as CoderClawConfig } from "../config/config.js";
