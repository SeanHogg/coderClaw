...
function mergeIMessageAccountConfig(cfg: CoderClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: CoderClawConfig): ResolvedIMessageAccount[] {
