...
| Document | Description |
|----------|-------------|
| [Pricing](/link/pricing/) | Free / Pro / Enterprise tiers, LLM add-ons, self-hosting, FAQ |
| [Go-to-Market Strategy](/link/go-to-market/) | Positioning, ICP, competitive landscape, acquisition channels, launch plan |

## Developer

| Document | Description |
|----------|-------------|
| [Visual Debugging](/link/visual-debugging/) | Timeline, list, and graph views for execution debugging |
