...
export function listZalouserAccountIds(cfg: CoderClawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: CoderClawConfig): string {
...
function mergeZalouserAccountConfig(cfg: CoderClawConfig, accountId: string): ZalouserAccountConfig {
