import type { ChannelOnboardingAdapter, CoderClawConfig, WizardPrompter } from "coderclaw/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.coderclaw.ai/channels/mattermost",
    ].join("\n"),
