...
CoderClaw (built on [OpenClaw](https://github.com/openclaw/openclaw)) defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
