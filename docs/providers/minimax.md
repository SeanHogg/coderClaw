...
See [MiniMax OAuth plugin README](https://github.com/SeanHogg/coderClaw/tree/main/extensions/minimax-portal-auth) for details.
...
- Use `coderclaw models list` and `coderclaw models set minimax/MiniMax-M2.1` to switch.
...
- Running `coderclaw configure` and selecting **MiniMax M2.1**, or
