...
Models are maintained in a separate repo: [vignesh07/coderclaw-formal-models](https://github.com/vignesh07/coderclaw-formal-models).
...
```bash
git clone https://github.com/vignesh07/coderclaw-formal-models
cd coderClaw-formal-models
