...
- `OPENCLAW_CONFIG_DIR=...` (default: `~/.coderclaw`) mounted to `/home/node/.openclaw`
- `OPENCLAW_WORKSPACE_DIR=...` (default: `~/.coderclaw/workspace`) mounted to `/home/node/.openclaw/workspace`
