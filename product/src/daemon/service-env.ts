...
export function buildServiceEnvironment(params: {
  ...
  const configPath =
    env.CODERCLAW_CONFIG_PATH?.trim() ||
    (stateDir ? path.join(stateDir, "coderclaw.json") : undefined);
  ...
  return {
    ...
    CODERCLAW_PROFILE: profile,
    CODERCLAW_STATE_DIR: stateDir,
    CODERCLAW_CONFIG_PATH: configPath,
    CODERCLAW_GATEWAY_PORT: String(port),
    CODERCLAW_GATEWAY_TOKEN: token,
    CODERCLAW_LAUNCHD_LABEL: resolvedLaunchdLabel,
    CODERCLAW_SYSTEMD_UNIT: systemdUnit,
    CODERCLAW_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    CODERCLAW_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    CODERCLAW_STATE_DIR: stateDir,
    CODERCLAW_CONFIG_PATH: configPath,
    CODERCLAW_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    CODERCLAW_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    CODERCLAW_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    CODERCLAW_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    CODERCLAW_LOG_PREFIX: "node",
    CODERCLAW_SERVICE_MARKER: NODE_SERVICE_MARKER,
    CODERCLAW_SERVICE_KIND: NODE_SERVICE_KIND,
    CODERCLAW_SERVICE_VERSION: VERSION,
  };
}
